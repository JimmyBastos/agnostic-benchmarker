...
<template>
  <!-- ROOT TAG -->
  <div id="app">
    <header class="app-header app-u-fixed app-u-pin-t app-u-shadow-lg">
      <!-- APP MENU -->
      <div class="app-container app-menu pure-menu pure-menu-horizontal">
        <!-- BRAND: framework@version -->
        <span class="app-menu-heading pure-menu-heading app-title">Vue</span>
      </div>
    ...
    <!-- APP TABLE -->
    <div class="app-container app-table-wrapper">
      <table class="app-table">
        <tbody class="app-table-body">
          <!-- COLOR -->
          <template v-for="{ color: label, id } of colors">
            <tr :key="id" :style="{ backgroundColor: label }" class="app-table-row">
              <!-- COLOR ID -->
              <td class="app-table-id">
                <span class="app-table-label" style="padding: 6px">{{ id }}</span>
              </td>

              <!-- COLOR LABEL -->
              <td class="app-table-cell">
                <span class="app-table-label">{{ label }}</span>
              </td>
              ...
              <td class="app-table-cell app-table-action">
                ...
                >
                  ...
                  >
                    <g fill="#fff">
                      <path
                        d="M1.7 25.2a1 1 0 0 0 1-1c0-6.065 4.935-11 11-11h24v8.964L51.4 12.2 37.7 2.236V11.2h-24a13.02 13.02 0 0 0-13 13 1 1 0 0 0 1 1zm38-19.036L48 12.2l-8.3 6.036V6.164zm10 20.036a1 1 0 0 0-1 1c0 6.065-4.935 11-11 11h-24v-8.964L0 39.2l13.7 9.964V40.2h24a13.02 13.02 0 0 0 13-13 1 1 0 0 0-1-1zm-38 19.036L3.4 39.2l8.3-6.036v12.072z"
                      ></path>
                    </g>
                  </svg>
                </a>
